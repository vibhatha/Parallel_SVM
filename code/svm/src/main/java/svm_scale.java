...
class svm_scale
{
    ...
    private void run(String []argv) throws IOException
    {
        ...
        String baseUrl = "/home/vibhatha/IdeaProjects/SVM_01/src/main/java/data/";
      ...
      //  {
        System.out.println(argv[1]);
            ...
            for (int j = 0; j < commands.length; j=j+2) {
                //System.out.println(commands[j]);
                if(commands[j].equals("-l")){
                    lower = Double.parseDouble(commands[j+1]);
                    System.out.println(lower);
                }
                if(commands[j].equals("-u")){
                    upper = Double.parseDouble(commands[j+1]);
                    System.out.println(upper);
                }
                if(commands[j].equals("-s")){
                    save_filename = (commands[j+2]);
                    data_filename = (commands[j+3]);
                    System.out.println(save_filename+"  "+data_filename);
                }
            }
  ...
  /*          if (argv[i].charAt(0) != '-')	break;
        ...
        try {
            fp = new BufferedReader(new FileReader(baseUrl+data_filename));
        } catch (Exception e) {
        ...
        fp = rewind(fp, baseUrl+data_filename);
        ...
        if(save_filename != null)
        {
            ...
            try {
                fp_save = new BufferedWriter(new FileWriter(baseUrl+save_filename));
            } catch(IOException e) {
